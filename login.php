...
try {
    ...
    // Procura o utilizador na tbl_users
    // Validamos também se a conta está ativa
    ...
    // Nota: Se as tuas passwords na DB não estiverem encriptadas, 
    // usamos comparação direta. Se estiverem (recomendado), usar password_verify.
